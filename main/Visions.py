    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                #     figure_gesture_id = point_history_classifier(
                #         pre_processed_point_history_list)
                    
                #Calculates the gestures IDs in the latest detection
        ...
        #Screen Reflection
        cv2.imshow('Hand Gestures Recognition', debug_image)
